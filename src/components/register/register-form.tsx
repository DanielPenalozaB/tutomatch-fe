  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error instanceof ApiResponseError) {
        ...
        } else if (error.message === 'Email domain not allowed. Valid domains are: estudiante.uniajc.edu.co, profesores.uniajc.edu.co, admon.uniajc.edu.co') {
          errorMessage = 'El dominio del correo electrónico no está permitido. Dominios permitidos: estudiante.uniajc.edu.co, profesores.uniajc.edu.co, admon.uniajc.edu.co';
        }
      }
  ...
  return (
    <div className={cn('flex flex-col gap-6', className)} {...props}>
            ...
            <div className="grid gap-6">
              <div className="grid gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Input id="name" type="text" value={formData.name} onChange={handleChange} placeholder="John Doe" required disabled={isLoading} />
                </div>
                <div className="grid gap-2">
                  <Label htmlFor="password">Contraseña</Label>
                  <Input id="password" type="password" autoComplete='new-password' value={formData.password} onChange={handleChange} required disabled={isLoading} />
                </div>
                <div className="grid gap-2">
      ...
      <div className="text-balance text-muted-foreground [&_a]:hover:text-primary text-center text-xs [&_a]:underline [&_a]:underline-offset-4">
        Al registrarte aceptas nuestros <a href="#">Términos de uso</a> y <a href="#">Políticas de privacidad</a>.
      </div>
    </div>
  );
}
